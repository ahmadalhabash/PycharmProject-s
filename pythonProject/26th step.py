class car():
    ...
    def insurance_calculation(self):
        ...
        if 2020 >= year_of_release >= 2010 and 6000 <= car_price <= 17000:
            calculation_insurance = car_price * 0.05

        else:
            calculation_insurance = car_price * 0.07

        print("Calculated Insurance price for the model  %s : , is %s " % (model, calculation_insurance))
