...
"""
Assignment Rules :
1) Businesses with gross incomes in between 1k - 2k will pay 5% tax.
...
5) All businesses wiil pay an additional 2% for healthcare out of
net income as well, after tax reduction, and just print it.

6) Also calculate the total tax you got from the given 10 businesses in the list (exclude healthcare)
...
for single_income in businesses_list:
    ...
    print("Pritn of the 'tax' variable " + str(tax))
