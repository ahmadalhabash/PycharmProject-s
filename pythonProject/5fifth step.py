# Collections - Lists, practice (advaced)

# Creat employees list
...
# New employees in the company - 'Mavrik' , lets add it to index '3' , without removing 'Danna
...
print("(5-b) - 'Mavrik' added to the end list : " + str(employees))
...
employees.sort()
print("Sorte list : " + str(employees))
# All right recreved to : https://www.programiz.com