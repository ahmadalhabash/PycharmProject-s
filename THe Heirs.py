...
the_remainder_of_the_heirs_after_calculating_the_individual_s_share = money_account[1] - (the_share_of_the_heirs_per_person[0] + the_share_of_the_heirs_per_person[1] + the_share_of_the_heirs_per_person[2]
